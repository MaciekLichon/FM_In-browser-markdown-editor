...
const Header: React.FC<IProps> = ({ saveDocument }) => {
    const { unsavedActiveDocument } = useUnsavedDocumentContext();
        ...
        <header className="header">
            ...
            <div className="header__file">
                ...
                <div className="header__file-buttons">
                    <button 
                        className="header__file-button header__file-button_delete" 
                        onClick={() => setModalStatus("open-delete")}
                    >
                    ...
                    <button 
                        className="header__file-button header__file-button_save button-action" 
                        onClick={() => saveDocument(unsavedActiveDocument)}
                    >
