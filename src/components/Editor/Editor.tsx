...
const Editor: React.FC = () => {
  ...
  }, [textAreaRef, unsavedActiveDocument.content]);
  // -----------

  return (
    <div
      className={`editor ${isPreviewFullWidth ? "editor_full-preview" : ""}`}
    >
      <div className="editor__section editor__markdown">
        <EditorSectionTitle title="markdown" />
        <textarea
          ref={textAreaRef}
          className="editor__section-fill editor__markdown-textarea"
          value={unsavedActiveDocument.content}
          onChange={(e) =>
            setUnsavedActiveDocument({
              ...unsavedActiveDocument,
      ...
      <div className="editor__section editor__preview">
        ...
        <div className="editor__section-fill markdown-preview">
          <Markdown children={unsavedActiveDocument.content} />
        </div>
      </div>
      <button
